...
function Home() {
    ...
    const handleChangeColor = () => {
        setMarkColor((prevMarkColor) => !prevMarkColor)
    };
    ...
    useEffect(() => {
        if (data.data && Array.isArray(data.data)) {
            const moviesOnly = data.data.filter(film => film.type === 'tv-series');
            setFilms(moviesOnly);
        } else {
    ...
    return (
        <div className="homePage">
            ...
            <div className="container">
                ...
                <h1>Saved movies and Tv series</h1>
