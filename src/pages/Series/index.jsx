...
function Home() {
    ...
    useEffect(() => {
        if (data.data && Array.isArray(data.data)) {
            const seriesOnly = data.data.filter(film => film.type === 'tv-series');
            setFilms(seriesOnly.map(film => ({ ...film, saved: !savedFilms.includes(film.id) })));
        } else {
        ...
        <div className="homePage">
            ...
            <div className="container">
                ...
                <div className="trending">
                    {
                        data.loading ? "Loading..." : films.map((film) => (
